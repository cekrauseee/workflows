...
The skills rely on the host's existing agent, file, Git, GitHub, validation, and browser tools. Those tools provide evidence; the agent remains responsible for scope, judgment, verification and truthful reporting. Successful tool execution does not establish task completion. User choices and repository rules override package preferences.
